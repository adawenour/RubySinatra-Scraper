# nokogiri is the scraping/parsing library
# to install it with "gem install nokogiri"
require 'nokogiri'
...
# Here load the URL into Nokogiri for parsing downloading the page in
# the process
data = Nokogiri::HTML(open(url))

# Can now target data in the page using css selectors.  The at_css method
