...
# Here is where used the new method to create an object that holds all the
...
concerts.each do |concert|
  ...
  # when a show is sold out, there is no div with the selector .price
  # What is happening here is setting price = to that selector.  We then test
  # to see whether it is nil or not which let's me know if the show is SOLD OUT.
